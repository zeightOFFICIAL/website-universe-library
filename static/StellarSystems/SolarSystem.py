...
Sun = ObjectClass(
    ...
    "Sun",
    "Star - Yellow Dwarf",
    ["8vh", "-4vh", "#fbff00", "#ff5e00", "20px", "#ffa600"],
    ["0vh", "0vh"],
    "0",
...
Mercury = ObjectClass(
    ...
    "Mercury",
    "Rocky planet",
    ["2vh", "-1vh", "#c34b4b", "rgb(140 118 119)", "0px", "#c34b4"],
    ["11vh", "-5.5vh"],
    "8",
...
Venus = ObjectClass(
    ...
    "Venus",
    "Greenhouse planet",
    ["4vh", "-2vh", "#ffdfa5", "rgb(211 139 51)", "5px", "pink"],
    ["18vh", "-9vh"],
    "22",
...
Moon = ObjectClass(
    ...
    "Moon",
    "Rocky satelite",
    ["1vh", "-0.5vh", "white", "grey", "0px", "white"],
    ["6vh", "-3vh"],
    "7",
...
Earth = ObjectClass(
    ...
    "Earth",
    "Home",
    ["4vh", "-2vh", "#1afcff", "rgb(92 100 255)", "5px", "#d7d9f5"],
    ["29vh", "-14.5vh"],
    "36",
    [
        earth0,
...
Jupiter = ObjectClass(
    ...
    "Jupiter",
    "Gas giant",
    ["7vh", "-3.5vh", "#ff8200", "#c5a572", "10px", "#ff8200"],
    ["59vh", "-29.5vh"],
    "433",
