...
ProxC = ObjectClass(
    ...
    ["6vh", "-3vh", "#0051ff", "#1e00ff", "10", "#0051ff"],
    ["30vh", "-15vh"],
    "1928",
...
ProxB = ObjectClass(
    ...
    "Proxima B",
    "Exoplanet - Rocky",
    ["4vh", "-2vh", "#ffadad", "#ffd9a7", "10", "#ffadad"],
    ["18vh", "-9vh"],
    "11",
...
Alpha = ObjectClass(
    ...
    "Alpha",
    "Star - Yellow Dwarf",
    ["10vh", "-5vh", "yellow", "orangered", "30", "yellow"],
    ["2vh", "-1vh"],
    "10",
...
Beta = ObjectClass(
    ...
    "Beta",
    "Star - Yellow Dwarf",
    ["7vh", "-3.5vh", "#F1AA1B", "orangered", "20", "#F1AA1B"],
    ["20vh", "-10vh"],
    "45",
