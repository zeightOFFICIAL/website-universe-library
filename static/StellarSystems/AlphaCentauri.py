...
# OBJECT PANELS
alpha_starter = HeaderTextPanel("APNL00", "Alpha", "", MAIN_COLOR, HEAD_COLOR)

# OBJECTS

# SYSTEM
SystemObject = SystemClass(1, "Alpha Centauri", [panel_starter, panel_middle1, panel_middle2, panel_middle3, panel_middle4, alpha_starter], [], "alternativeicon.ico") 