...
Sun = ObjectClass(
    ...
    "Sun",
    "Star - Yellow Dwarf",
    ["8vh", "-4vh", "#fbff00", "#ff5e00", "15", "#ffa600"],
    ["0vh", "0vh"],
    "0",
...
Venus = ObjectClass(
    ...
    "Venus",
    "Greenhouse planet",
    ["4vh", "-2vh", "#ffdfa5", "rgb(211 139 51)", "2", "pink"],
    ["18vh", "-9vh"],
    "22",
...
Earth = ObjectClass(
    ...
    "Earth",
    "Home",
    ["4vh", "-2vh", "#1afcff", "rgb(92 100 255)", "1", "#d7d9f5"],
    ["29vh", "-14.5vh"],
    "36",
    [
        earth0,
...
Jupiter = ObjectClass(
    ...
    "Jupiter",
    "Gas giant",
    ["7vh", "-3.5vh", "#ff8200", "#c5a572", "1", "#ff8200"],
    ["59vh", "-29.5vh"],
    "433",
